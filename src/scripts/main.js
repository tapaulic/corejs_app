/*
 The main javascript file for corejs_app.
 IMPORTANT:
 ...
 This is because this app's files will exist on an S3 bucket resources/corejs_app
...
$(function () {
  ...
  form.render($('.corejs_app_container'));
});
